...
%\begin{backgroundblock}{2.5cm}{8.0cm}
%\includegraphics[width=0.4\paperwidth]{../img/umstrip.pdf}
%\end{backgroundblock}
...
\begin{backgroundblock}{1.2cm}{5.0cm}
...
\includegraphics[width=0.7\paperwidth]{../img/softdia.pdf}
\end{backgroundblock}
\Large Specifications:\\
\normalsize
\begin{itemize}
...
\item Components:
	...
	\item Decoder
	\end{itemize}
\item Goal $\rightarrow$ implement into GBT Example Design
\end{itemize}
...
\begin{backgroundblock}{1.5cm}{6cm}
...
\normalsize
\begin{itemize}
\item Send/Receive and User Interface modules works
