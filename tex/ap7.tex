...
Table \ref{tab:ccode} lists the different C files that make up the GBT control interface module and the send/receive module. For more information about the actual functions described in the files, see appendix \ref{chap:clibs}.
...
Table \ref{tab:vhdcode} lists the different VHDL files used in this thesis. For more information, see section \ref{chap:hardcomp}. 
...
\hline
 ...
 uart\_gbt\_pkg.vhd & Defines constants (request-bytes and uart data bit width) and records. \\ %\hline
