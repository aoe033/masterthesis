...
\node[rectangle] (a3) [draw, minimum width=3cm,minimum height=3cm,right of=a2,node distance=6cm] {VLDB};

\node[MyArrow] (t1) [right of = a2, node distance=2.0cm, xshift=7.5mm, yshift=-0.5cm, minimum width=1cm, minimum height=4.5cm]{\textcolor{black}{e-links}};
\node[MyArrow] (t2) [right of = a2, shape border rotate=180, node distance=2.0cm, xshift=7.5mm, yshift=0.8cm,  minimum width=0.2cm, minimum height=4.2cm]{\textcolor{black}{optical}};
