...
\begin{tikzpicture}
	...
	\node (pro1a) [process, below left = 0.5cm of dec1a] {Send \textit{txData} to COM};
	...
	\node (dec3) [decision, below = 0.5cm of pro2a] {Check pattern table with \textit{txAdr} as index};
	...
	\node (pro5) [process, below = 0.5cm of pro4] {Send \textit{txData} to COM};
	...
	\node (pro8a) [process, right = 0.5cm of dec6] {Increment pattern index};
	\node (pro8b) [process, left = 0.5cm of dec6] {Set pattern index = 0};
