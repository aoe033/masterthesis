...
, where $\epsilon_r$ is the dielectric constant of the dielectric material, FR4, often used as a material to separate the copper layers on the \glspl{pcb}. $\epsilon_r = 4.05$ @ $3\ \giga\hertz$ \cite{polar15}.
