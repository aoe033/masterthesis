...
\begin{frame}[t]
\frametitle{Transmit/Receive Module}

\begin{backgroundblock}{4.5cm}{3cm}
\includegraphics[width=0.6\paperwidth]{../img/prgcycle.pdf}
\end{backgroundblock}

\begin{itemize}
\item Transmit 2 bytes, receive 1 byte
