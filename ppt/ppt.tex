...
\item E-links $\rightarrow$ $320~\mega\bit\per\second$ detector data using HDMI-connector
\item Optical-Fiber $\rightarrow$ $4.8~\giga\bit\per\second$ GBT data using SFP fiber-module
\end{itemize}
...
\begin{itemize}
\item $4.8~\giga\bit\per\second$ $\rightarrow$ transmission line if trace \textless~ $3.1~\centi\meter$
\end{itemize}
...
\begin{backgroundblock}{6cm}{6.5cm}
\includegraphics[width=0.5\paperwidth]{../img/softdia.pdf}
\end{backgroundblock}

\begin{itemize}
\item Send/receive control signal information
\item 
\end{itemize}
